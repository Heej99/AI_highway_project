    ...
    def makeFHDList(self,SkipSec=0,frame_num=500,saveFHD=False):       
        ...
        while cap.isOpened():
            ...
            if ret:
                ...
                currentFrameNumberTemp = currentFrameNumber
                count_second =  currentFrameNumberTemp//60
                #print(skipVal,skipGPS,skipGPS + round(skipVal / fps * 18))
                skipGPS = count_second*18 + round(skipVal / fps * 18) #calculate next speed
