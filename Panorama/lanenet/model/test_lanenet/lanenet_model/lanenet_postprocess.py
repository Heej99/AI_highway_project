...
class LaneNetPostProcessor(object):
    ...
    def __init__(self, cfg):
        ...
        """
        self._cfg = cfg
        self._ipm_remap_file_path = self._cfg.TEST.IPM_REMAP_FILE_PATH
        assert ops.exists(self._ipm_remap_file_path), '{:s} not exist'.format(self._ipm_remap_file_path)
    ...
    def postprocess(self, binary_seg_result, instance_seg_result=None,
        ...
        for index, single_lane_pts in enumerate(src_lane_pts):
            ...
            for plot_y in np.linspace(start_plot_y, end_plot_y, step):
                ...
                # point coord append
                lane_point_list.append([index,int(interpolation_src_pt_x),int(interpolation_src_pt_y)])
